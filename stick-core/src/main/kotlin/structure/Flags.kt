...
fun <S : Environment, O> SenderScope<S, O>.flag(
...
fun <S : Environment, O, T : Any> SenderScope<S, O>.flag(
...
inline fun <S : Environment, O, reified T : Any> SenderScope<S, O>.flag(
    name: String,
...
fun <S : Environment, O, T : Any> SenderScope<S, O>.valueFlag(
    id: TypedIdentifier<T>,
    default: ContextualValue<S, O, T>,
...
inline fun <S : Environment, O, reified T : Any> SenderScope<S, O>.valueFlag(
    name: String,
    noinline default: ContextualValue<S, O, T>,
