...
fun <S : SenderContext> SenderScope<S>.flag(
...
fun <S : SenderContext, T : Any> SenderScope<S>.flag(
...
inline fun <S : SenderContext, reified T : Any> SenderScope<S>.flag(
    name: String,
...
fun <S : SenderContext, T : Any> SenderScope<S>.valueFlag(
    id: TypedIdentifier<T>,
    default: ContextualValue<S, T>,
...
inline fun <S : SenderContext, reified T : Any> SenderScope<S>.valueFlag(
    name: String,
    noinline default: ContextualValue<S, T>,
