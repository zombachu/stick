...
fun <E : Environment, O> SenderScope<E, O>.group(
    vararg elements: StructureElement<E, O, Groupable<E, O, *>>,
    description: String = "",
): StructureElement<E, O, Group<E, O>> = {
    val groupScope = StructureScope<E, O>(
