...
internal class Signature0<E_ : Environment, S>(
    val execute: Invocation<E_, S>.() -> ExecutionResult,
    elements: Tuple0<SignatureConstraint<E_, S, Any>>,
): Signature<E_, S>(elements) {
    override fun executeParsed(context: Invocation<E_, S>, parsedValues: List<Any>): ExecutionResult {
        return context.execute()
    }
}

internal class Signature1<E_ : Environment, S, A : Any>(
    val execute: Invocation<E_, S>.(A) -> ExecutionResult,
    elements: Tuple1<SignatureConstraint<E_, S, Any>,
...
internal class Signature2<E_ : Environment, S, A : Any, B : Any>(
    val execute: Invocation<E_, S>.(A, B) -> ExecutionResult,
    elements: Tuple2<SignatureConstraint<E_, S, Any>,
...
internal class Signature3<E_ : Environment, S, A : Any, B : Any, C : Any>(
    val execute: Invocation<E_, S>.(A, B, C) -> ExecutionResult,
    elements: Tuple3<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
...
internal class Signature4<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D) -> ExecutionResult,
    elements: Tuple4<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
...
internal class Signature5<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E) -> ExecutionResult,
    elements: Tuple5<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
...
internal class Signature6<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any, F : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E, F) -> ExecutionResult,
    elements: Tuple6<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
            SignatureConstraint.NonTerminating<E_, S, D>,
...
internal class Signature7<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any, F : Any, G : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E, F, G) -> ExecutionResult,
    elements: Tuple7<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
            SignatureConstraint.NonTerminating<E_, S, D>,
...
internal class Signature8<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any, F : Any, G : Any, H : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E, F, G, H) -> ExecutionResult,
    elements: Tuple8<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
            SignatureConstraint.NonTerminating<E_, S, D>,
...
internal class Signature9<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any, F : Any, G : Any, H : Any, I : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E, F, G, H, I) -> ExecutionResult,
    elements: Tuple9<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
            SignatureConstraint.NonTerminating<E_, S, D>,
...
internal class Signature10<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any, F : Any, G : Any, H : Any, I : Any, J : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E, F, G, H, I, J) -> ExecutionResult,
    elements: Tuple10<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
            SignatureConstraint.NonTerminating<E_, S, D>,
...
internal class Signature11<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any, F : Any, G : Any, H : Any, I : Any, J : Any,
        K : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E, F, G, H, I, J, K) -> ExecutionResult,
    elements: Tuple11<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
            SignatureConstraint.NonTerminating<E_, S, D>,
...
internal class Signature12<E_ : Environment, S, A : Any, B : Any, C : Any, D : Any, E : Any, F : Any, G : Any, H : Any, I : Any, J : Any,
        K : Any, L : Any>(
    val execute: Invocation<E_, S>.(A, B, C, D, E, F, G, H, I, J, K, L) -> ExecutionResult,
    elements: Tuple12<SignatureConstraint<E_, S, Any>,
            SignatureConstraint.NonTerminating<E_, S, A>,
            SignatureConstraint.NonTerminating<E_, S, B>,
            SignatureConstraint.NonTerminating<E_, S, C>,
            SignatureConstraint.NonTerminating<E_, S, D>,
