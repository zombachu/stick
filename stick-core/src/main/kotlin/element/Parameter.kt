...
sealed class Parameter<S : Environment, O, T : Any>(
    ...
    sealed class FixedSize<S : Environment, O, T : Any>(
        override val size: Size.Fixed,
        id: TypedIdentifier<T>,
        description: String,
    ) : Parameter<S, O, T>(size, id, description), SignatureConstraint.NonTerminating<S, O, T>
    abstract class Size1<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size2<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size3<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size4<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size5<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size6<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size7<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size8<S : Environment, O, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class UnknownSize<S : Environment, O, T : Any>(
        size: Size,
        id: TypedIdentifier<T>,
        description: String,
