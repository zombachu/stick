...
sealed class Parameter<S : SenderContext, O, T : Any>(
    ...
    abstract class Size1<S : SenderContext, O, T : Any>(id: TypedIdentifier<T>, description: String) :
        ...
        final override fun parse(context: ExecutionContext<S, O>, args: List<String>): Result<out T> {
            return parse(context, args[0])
        }
        abstract fun parse(context: ExecutionContext<S, O>, arg0: String): Result<out T>
    }
    abstract class Size2<S : SenderContext, O, T : Any>(id: TypedIdentifier<T>, description: String) :
        ...
        abstract fun parse(context: ExecutionContext<S, O>, arg0: String, arg1: String): Result<out T>
    }
    abstract class Size3<S : SenderContext, O, T : Any>(id: TypedIdentifier<T>, description: String) :
        ...
        abstract fun parse(context: ExecutionContext<S, O>, arg0: String, arg1: String, arg2: String): Result<out T>
    }
    abstract class Size4<S : SenderContext, O, T : Any>(id: TypedIdentifier<T>, description: String) :
        ...
        abstract fun parse(context: ExecutionContext<S, O>, arg0: String, arg1: String, arg2: String,
    ...
    abstract class Size5<S : SenderContext, O, T : Any>(id: TypedIdentifier<T>, description: String) :
        ...
        abstract fun parse(context: ExecutionContext<S, O>, arg0: String, arg1: String, arg2: String, arg3: String,
