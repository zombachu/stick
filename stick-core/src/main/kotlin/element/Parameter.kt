...
sealed class Parameter<O, S : SenderContext<O>, T : Any>(
    ...
    sealed class FixedSize<O, S : SenderContext<O>, T : Any>(
        override val size: Size.Fixed,
        id: TypedIdentifier<T>,
        description: String,
    ) : Parameter<O, S, T>(size, id, description), SignatureConstraint.NonTerminating<O, S, T>
    abstract class Size1<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size2<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size3<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size4<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size5<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size6<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size7<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class Size8<O, S : SenderContext<O>, T : Any>(id: TypedIdentifier<T>, description: String) :
    ...
    abstract class UnknownSize<O, S : SenderContext<O>, T : Any>(
        size: Size,
        id: TypedIdentifier<T>,
        description: String,
