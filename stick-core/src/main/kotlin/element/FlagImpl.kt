...
internal open class FlagImpl<S : Environment, O, T : Any>(
...
internal sealed class FlagParameter<S : Environment, O, T : Any>(
    size: Size.Fixed,
    ...
    internal class PresenceFlagParameter<S : Environment, O, T : Any>(
        id: TypedIdentifier<T>,
    ...
    internal class ValueFlagParameter<S : Environment, O, T : Any>(
        id: TypedIdentifier<T>,
