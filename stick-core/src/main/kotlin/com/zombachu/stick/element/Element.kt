...
sealed interface Groupable<E : Environment, S, T> : SyntaxElement<E, S, T>, SignatureConstraint<E, S, T> {
    context(validationContext: ValidationContext<E, S>)
    fun getGroupedSyntax(): String = name

    sealed interface NonTerminating<E : Environment, S, T> : Groupable<E, S, T>, SignatureConstraint.NonTerminating<E, S, T>, Terminating<E, S, T>
    sealed interface Terminating<E : Environment, S, T> : Groupable<E, S, T>, SignatureConstraint.Terminating<E, S, T>
}
...
sealed interface Group<E : Environment, S, G : GroupResult> : SyntaxElement<E, S, G>, SignatureConstraint<E, S, G> {
    sealed interface UnknownSize<E : Environment, S, G : GroupResult> : Group<E, S, G>, SignatureConstraint.Terminating<E, S, G>
    sealed interface FiniteSize<E : Environment, S, G : GroupResult> : Group<E, S, G>, SignatureConstraint.NonTerminating<E, S, G>
}
...
sealed interface ValidatedParameter<E : Environment, S, T> : Groupable<E, S, T> {
    sealed interface UnknownSize<E : Environment, S, T> : ValidatedParameter<E, S, T>, Groupable.Terminating<E, S, T>
    sealed interface FixedSize<E : Environment, S, T> : ValidatedParameter<E, S, T>, Groupable.NonTerminating<E, S, T>
}
