...
data class Arguments5<A, B, C, D, E>(
...
data class Arguments6<A, B, C, D, E, F>(
...
data class Arguments12<A, B, C, D, E, F, G, H, I, J, K, L>(
    val a: A, val b: B, val c: C, val d: D, val e: E, val f: F, val g: G, val h: H, val i: I, val j: J, val k: K, val l: L
) : Arguments {
    context(inv: Invocation<E_, S>)
