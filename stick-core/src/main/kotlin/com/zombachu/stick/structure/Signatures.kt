...
): Structure<E_, S, Arguments0> =
    this@invoke.build(Signature0(
        execute,
        emptyList()))
...
operator fun <E_ : Environment, S, A, B> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature2(
        execute,
        listOf(elementA, elementB)))
...
operator fun <E_ : Environment, S, A, B, C> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature3(
        execute,
        listOf(elementA, elementB, elementC)
    ))
...
operator fun <E_ : Environment, S, A, B, C, D> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature4(
        execute,
        listOf(elementA, elementB, elementC, elementD)
    ))
...
operator fun <E_ : Environment, S, A, B, C, D, E> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature5(
        execute,
        listOf(elementA, elementB, elementC, elementD, elementE)
    ))
...
operator fun <E_ : Environment, S, A, B, C, D, E, F> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature6(
        execute,
        listOf(elementA, elementB, elementC, elementD, elementE, elementF)
    ))
...
operator fun <E_ : Environment, S, A, B, C, D, E, F, G> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature7(
        execute,
        listOf(elementA, elementB, elementC, elementD, elementE, elementF, elementG)
    ))
...
operator fun <E_ : Environment, S, A, B, C, D, E, F, G, H> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature8(
        execute,
        listOf(elementA, elementB, elementC, elementD, elementE, elementF, elementG, elementH)
    ))
...
operator fun <E_ : Environment, S, A, B, C, D, E, F, G, H, I, J, K> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature11(
        execute,
        listOf(elementA, elementB, elementC, elementD, elementE, elementF, elementG, elementH, elementI, elementJ, elementK)
    ))
...
operator fun <E_ : Environment, S, A, B, C, D, E, F, G, H, I, J, K, L> StructureScope<E_, S>.invoke(
    ...
    this@invoke.build(Signature12(
        execute,
        listOf(elementA, elementB, elementC, elementD, elementE, elementF, elementG, elementH, elementI, elementJ, elementK, elementL)
    ))
